// Write a program to read 4 values of any data types in the function main() & pass them to a function
//  updation(). In the called function raise the values of the first and last variable by 4 times and lower the values of the second and third by half. 
